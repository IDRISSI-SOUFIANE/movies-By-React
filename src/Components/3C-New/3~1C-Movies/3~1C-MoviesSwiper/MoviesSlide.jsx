...
const MoviesSlide = () => {
  ...
  // const [poUp, setPoUp] = useState("true");
  // ${poUp == true ? "active" : undefined}

  // useEffect(() => {
  //   let poup = document.getElementsByClassName("poup");
  //   poup.array.forEach((element) => {
  //     console.log(element);
  //   });

  //   // poup.addEventListener("click", (e) => console.log(e.target));
  // }, []);
        ...
        {movies &&
          ...
          movies.map((movie) => (
            ...
            >
              ...
              {/* <div className="poup">hello</div> */}
              {activeSlide === movie.id ? (
                <div className="poup active"></div>
              ) : (
                <div className="poup">hello</div>
              )}
            </SwiperSlide>
